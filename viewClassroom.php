...
<?php
	...
	include 'dbconn.php';
			...
			$sql="select * from classroom"; //echo $sql;
...
<table id="customers">
  <tr>
		...
		<th><strong><em> Link </em></strong></td>
  </tr>
  <?php
  include 'dbconn.php';
  ...
  <tr>
	...
	<td><a href="<?php echo $r["link"]; ?>" target="_blank"  > <?php echo $r["link"]; ?></a>&nbsp;</td>
  </tr>
  <?php } ?>
</table>
<?php } ?>
